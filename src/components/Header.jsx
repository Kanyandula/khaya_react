           ...
           px-3 max-w-6xl mx-auto">
            ...
            <div>
              <ul className="flex space-x-10">
                ...
                text-gray-400 border-b-[3px]
                border-b-transparent
                ${pathMathRoute("/sign-up") && "text-black border-b-blue-500"}`}>SignUp</li>
                <li
                className={`cursor-pointer py-3 text-sm font-semibold
                text-gray-400 border-b-[3px]
                border-b-transparent
                ${pathMathRoute("/forgot-password") && "text-black border-b-blue-500"}`}>ForgotPassword</li>
                <li
                className={`cursor-pointer py-3 text-sm font-semibold
                text-gray-400 border-b-[3px]
                border-b-transparent
                ${pathMathRoute("/profile") && "text-black border-b-blue-500"}`}>Profile</li> */}
              </ul>
            </div>
           </header>
    </div>
